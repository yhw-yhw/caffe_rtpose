...
./build/examples/rtpose/rtpose.bin --image_dir /mnt/sda1/yihongwei/dataset/test_data/test_image --write_frames /mnt/sda1/yihongwei/dataset/test_data/test_image_AI/ --write_json  /mnt/sda1/yihongwei/dataset/test_data/test_image_json_AI/ --logtostderr --v 2 --v 5 --part_to_show 0 --no_frame_drops true 2>&1 | tee output.txt
